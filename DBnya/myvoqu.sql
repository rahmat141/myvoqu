...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Apr 2020 pada 17.35
...
--
-- Struktur dari tabel `group_comment`
--
...
--
-- Struktur dari tabel `group_information`
--
...
--
-- Dumping data untuk tabel `group_information`
--
...
--
-- Struktur dari tabel `group_notif`
--
...
--
-- Dumping data untuk tabel `group_notif`
--
...
--
-- Struktur dari tabel `group_postingan`
--
...
(25, 'penghafal injil', 'jalan ninja kita sama', '', 77);
...
--
-- Dumping data untuk tabel `katmateri`
--
...
(217, 'yummy', 85, '', '5e9469a774f35.mp4', '<div class=\"video-wrapper\"><video class=\"post-video\" controls><source src=http://localhost/tubes-ci/assets_user/file_upload/5e9469a774f35.mp4 type=\"video/mp4\"></video></div>', '1586784679'),
...
--
-- Struktur dari tabel `trigger_user`
--
...
--
-- Dumping data untuk tabel `trigger_user`
--
...
(41, 'Jeki', 'Male', 'jaki@gmail.com', 'KTM2.jpg', '$2y$10$VPWRjJtMRr1FLWpVAC91QuIgLOKATtll33owfV52VSJztS0Zt6Udy', 1, 1, 1579687251, 'offline-dot', '0000-00-00', '', '', '', '', '', 0),
...
(74, 'Rahmat', 'Male', 'rahmatibrahim141@gmail.com', 'default.png', '$2y$10$oxVDkKT8z2tVBv3jqF6UNeRNBPNNHHTJlkp7ahB1978W2iVmCFe1e', 3, 1, 1584434428, 'online-dot', '0000-00-00', '', 'Hello World!', '', 'Instansi', '5e708cfc4fc36.png', 0),
...
(79, 'Kipli', 'Male', 'kipli@mail.com', 'default.png', '$2y$10$bQ0yeWos60h4ghzbabUi2uu5qjrpvkieUO1fmhOg1E5XVqohrejs.', 2, 1, 1585034822, '', '0000-00-00', '', 'Hello World!', '', 'MUI', '5e79b64623bf8.jpg', 0),
...
(84, 'Rintani', 'Female', 'rin@mail.com', 'default.png', '$2y$10$veFoTsJvj3OMUZF9e7FNI.MRr6K5E3MWD6JVcW32xMqk9ZqsAMl/O', 2, 0, 1586752244, '', '0000-00-00', '', 'Hello World!', '', '', '', 0),
...
--
-- Indeks untuk tabel `group_comment`
--
...
--
-- Indeks untuk tabel `group_information`
--
...
--
-- Indeks untuk tabel `group_notif`
--
ALTER TABLE `group_notif`
  ADD PRIMARY KEY (`id_notif`);

--
-- Indeks untuk tabel `group_postingan`
--
...
--
-- Indeks untuk tabel `trigger_user`
--
...
--
-- AUTO_INCREMENT untuk tabel `group_comment`
--
ALTER TABLE `group_comment`
  MODIFY `id_comment` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT untuk tabel `group_information`
--
ALTER TABLE `group_information`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT untuk tabel `group_notif`
--
ALTER TABLE `group_notif`
  MODIFY `id_notif` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT untuk tabel `group_postingan`
--
ALTER TABLE `group_postingan`
...
--
-- AUTO_INCREMENT untuk tabel `katmateri`
--
ALTER TABLE `katmateri`
...
--
-- AUTO_INCREMENT untuk tabel `postgen`
--
ALTER TABLE `postgen`
...
--
-- AUTO_INCREMENT untuk tabel `trigger_user`
--
ALTER TABLE `trigger_user`
...
--
-- Ketidakleluasaan untuk tabel `postgen`
--
ALTER TABLE `postgen`
